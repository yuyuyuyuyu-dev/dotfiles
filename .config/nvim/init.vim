...
" プラグインの設定
" vim-plugの設定を読み込む
source plugin_settings/vim-plug_setting.vim

" vim-indent-guidesの設定を読み込む
source plugin_settings/vim-indent-guides_setting.vim

" aleの設定を読み込む
source plugin_settings/ale_setting.vim

" deoplete.nvimの設定を読み込む
source plugin_settings/deoplete_setting.vim

" vim-lspの設定を読み込む
source plugin_settings/vim-lsp_setting.vim
